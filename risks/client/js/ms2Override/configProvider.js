const CONFIGPROVIDER = {
    ...
    EuropeanCommission: {
        ...
        options: {
            attribution: '<a href="http://europa.eu/index_en.htm">European Union</a>',                
            maxZoom: 18                
        },
        variants: {
            default: {},
            Natural: {
                url: 'http://europa.eu/webtools/maps/tiles/natural/{z}/{y}/{x}.png',
                options: {
                    attribution: '<a href="http://europa.eu/index_en.htm">European Union Natural</a>',
                    maxZoom: 6
                }
            }
